...
public class RulesParser
{
	...
	public void parse()
	{
		...
		EndParser endParser = new EndParser(this, sentences, lemmas, partsOfSpeech, pieceTypes);
		endParser.parseEndConditions();
		this.endConditions = endParser.getEndConditions();
	}
